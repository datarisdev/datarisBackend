...
API_ROUTERS: tuple[RouterRegistration, ...] = (
    ...
    RouterRegistration(compat_companies_admin.router, settings.API_V1_STR),
    RouterRegistration(compat_sig.router, settings.API_V1_STR),
    RouterRegistration(compat_field_log.router, settings.API_V1_STR),
    ...
    RouterRegistration(module_access_admin.router, settings.API_V1_STR),
